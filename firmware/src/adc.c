...
void ADC_ResultHandler(uintptr_t context)
{
    ...
    adc_arr[1] = ADC_ResultGet(ADC_RESULT_BUFFER_1);   // AN5
    adc_arr[2] = ADC_ResultGet(ADC_RESULT_BUFFER_2);   // AN9 
    adc_arr[3] = ADC_ResultGet(ADC_RESULT_BUFFER_3);   // AN15
    result_ready = true;
}
